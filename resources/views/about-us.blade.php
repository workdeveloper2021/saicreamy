...
@section('content');
    ...
    <div class="features-section style-two">
        <div class="shape_wrapper shape_one">
            <div class="shape_inner shape_two" style="background-image: url(images/background/37.jpg);"><div class="overlay"></div></div>
        </div>
    ...
    <!-- Chef Section -->
    <section class="chef-section" style="background-image: url(images/background/38.jpg);">
        <div class="auto-container">
            <div class="row">
                ...
                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <figure class="image"><img src="images/resource/old_man.png" alt=""></figure>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Our Standards -->
    <section class="our-standards" style="background-image: url(images/background/39.jpg);">
        <div class="auto-container">
            <div class="row">
