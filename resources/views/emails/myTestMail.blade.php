      ...
      <tbody>
        <tr style="vertical-align: top" valign="top">
          <td style="word-break: break-word; vertical-align: top" valign="top">
            ...
            <div style="background-color: #ec91a1">
              <div
                class="block-grid"
                style="
                  min-width: 320px;
    ...
    font-size: 20px;
                      ...
                      >
                        ...
                        ">
                              ...
                              <p>{{$order->address}} {{$order->address2}}<br>{{$order->city}}, {{$order->state}}, {{$order->country}}, {{$order->pincode}}, M: {{$order->contact}}</p><br>
                        </div>
                        </div>
                        <!--[if (!mso)&(!IE)]><!-->
                      </div>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              Order number:
                              <span style="color: #ec91a1"
                                ><strong>0000{{$order->id}}</strong></span
                              >
                            </p>
                          </div>
                        </div>
                        ...
                        >
                         <a
                            ...
                            style="
                              ...
                              width: auto;
                              width: auto;
                              border-top: 1px solid #ec91a1;
                              border-right: 1px solid #ec91a1;
                              border-bottom: 1px solid #ec91a1;
                              border-left: 1px solid #ec91a1;
                              padding-top: 5px;
                              padding-bottom: 5px;
                              font-family: Nunito, Arial, Helvetica Neue,
                                Helvetica, sans-serif;
