                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-shrink-0 me-3">
                            <img src="{{ URL::to('/admin') }}/assets/images/users/avatar-1.jpg" alt="" class="avatar-sm rounded-circle img-thumbnail">
                        </div>
                            ...
                            <div class="tab-pane active" id="post-recent" role="tabpanel">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item py-3">
                                        <div class="d-flex">
                                            <div class="me-3">
                                                <img src="{{ URL::to('/admin') }}/assets/images/small/img-2.jpg" alt="" class="avatar-md h-auto d-block rounded">
                                            </div>
                                    ...
                                    <li class="list-group-item py-3">
                                        <div class="d-flex">
                                            <div class="me-3">
                                                <img src="{{ URL::to('/admin') }}/assets/images/small/img-6.jpg" alt="" class="avatar-md h-auto d-block rounded">
                                            </div>
                                            <div class="align-self-center overflow-hidden me-auto">
                                                <div>
                                    ...
                                    <li class="list-group-item py-3">
                                        <div class="d-flex">
                                            <div class="me-3">
                                                <img src="{{ URL::to('/admin') }}/assets/images/small/img-1.jpg" alt="" class="avatar-md h-auto d-block rounded">
                                            </div>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item py-3">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar-xs">
                                            <img src="{{ URL::to('/admin') }}/assets/images/users/avatar-2.jpg" alt="" class="img-fluid d-block rounded-circle">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 100px;"><img src="{{ URL::to('/admin') }}/assets/images/small/img-2.jpg" alt="" class="avatar-md h-auto d-block rounded"></td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="{{ URL::to('/admin') }}/assets/images/small/img-6.jpg" alt="" class="avatar-md h-auto d-block rounded"></td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="{{ URL::to('/admin') }}/assets/images/small/img-1.jpg" alt="" class="avatar-md h-auto d-block rounded"></td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="{{ URL::to('/admin') }}/assets/images/small/img-2.jpg" alt="" class="avatar-md h-auto d-block rounded"></td>
                                    <td>
